  ...
  data () {
    ...
    return {
      columns: [
        ...
        { title: 'bankName', key: 'bankName', width: 180, ellipsis: true, sortable: true, table: true, detail: true },
        { title: 'companyName', key: 'companyName', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'contacts', key: 'contacts', width: 120, ellipsis: true, table: true, detail: true },
        { title: 'createdBy', key: 'createdBy', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'createdTime', key: 'createdTime', width: 100, ellipsis: true, table: true, detail: true },
        ...
        { title: 'invoiceType', key: 'invoiceType', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'logisticsType', key: 'logisticsType', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'name', key: 'name', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'packageOrNot', key: 'packageOrNot', width: 180, ellipsis: true, sortable: true, table: true, detail: true },
        { title: 'revision', key: 'revision', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'supplierCompanyName', key: 'supplierCompanyName', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'taxPoint', key: 'taxPoint', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'tel', key: 'tel', width: 180, ellipsis: true, sortable: true, table: true, detail: true },
