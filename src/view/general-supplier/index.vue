...
export default {
  ...
  data () {
    ...
    return {
      columns: [
        { title: '收款帐号', key: 'bankAccount', width: 100, ellipsis: true, table: true, detail: true },
        { title: '收款开户行', key: 'bankName', width: 180, ellipsis: true, sortable: true, table: true, detail: true },
        { title: '供应商公司名称', key: 'companyName', width: 100, ellipsis: true, table: true, detail: true },
        { title: '联系人', key: 'contacts', width: 120, ellipsis: true, table: true, detail: true },
        { title: 'createdBy', key: 'createdBy', width: 100, ellipsis: true, table: false, detail: false },
        { title: 'createdTime', key: 'createdTime', width: 100, ellipsis: true, table: false, detail: false },
        { title: 'enableFlag', key: 'enableFlag', width: 100, ellipsis: true, table: false, detail: false },
        { title: 'ID', key: 'id', width: 100, ellipsis: true, sortable: true, table: true, detail: true },
        { title: '发票类别', key: 'invoiceType', width: 100, ellipsis: true, table: true, detail: true },
        { title: '物流类别', key: 'logisticsType', width: 100, ellipsis: true, table: true, detail: true },
        { title: 'name', key: 'name', width: 100, ellipsis: true, table: false, detail: false },
        { title: '是否包邮', key: 'packageOrNot', width: 180, ellipsis: true, sortable: true, table: true, detail: true },
        { title: 'revision', key: 'revision', width: 100, ellipsis: true, table: false, detail: false },
        { title: '供应商公司名称', key: 'supplierCompanyName', width: 100, ellipsis: true, table: true, detail: true },
        { title: '税点', key: 'taxPoint', width: 100, ellipsis: true, table: true, detail: true },
        { title: '电话', key: 'tel', width: 180, ellipsis: true, sortable: true, table: true, detail: true },
      ...
      form: {},
      searchFormList: [
        { title: 'queryVO', key: 'queryVO' }, { title: 'name', key: 'name' }
      ],
      searchForm: {
        queryVO: '', name: '', pageSize: 10, currPage: 1
      },
      page: { total: 0 }
    }
  },
