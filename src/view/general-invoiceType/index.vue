  ...
  data () {
    ...
    return {
      columns: [
        ...
        { title: '发票类别ID', key: 'invoiceTypeId', width: 120, ellipsis: true, table: true, detail: true },
        { title: '发票类别名称', key: 'invoiceTypeName', width: 150, ellipsis: true, table: true, detail: true },
