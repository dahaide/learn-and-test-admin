  ...
  data () {
    ...
    return {
      columns: [
        ...
        { title: 'goodsTypeId', key: 'goodsTypeId', width: 120, ellipsis: true, table: true, detail: true },
        { title: 'goodsTypeName', key: 'goodsTypeName', width: 150, ellipsis: true, table: true, detail: true },
